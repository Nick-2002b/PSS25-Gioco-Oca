...
public final class MenuViewImpl implements MenuView {
    ...
    public void show() {
        ...
        final Button btnSettings = createButton(
                "Impostazioni",
                "/images/icons/settingsIcon.png",
                this.controller::onOpenSettings);
    ...
    private Button createButton(final String text, final String iconPath, final Runnable action) {
